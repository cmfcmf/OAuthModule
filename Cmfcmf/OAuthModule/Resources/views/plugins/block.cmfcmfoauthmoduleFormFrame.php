...
/**
 * The cmfcmfoauthmoduleFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_cmfcmfoauthmoduleFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('\\Cmfcmf\\OAuthModule\\Form\\Plugin\\FormFrame', $params, $content);
