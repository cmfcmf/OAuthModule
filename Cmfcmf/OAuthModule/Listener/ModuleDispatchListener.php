...
use Cmfcmf\OAuthModule\Listener\Base\ModuleDispatchListener as BaseModuleDispatchListener;
...
class ModuleDispatchListener extends BaseModuleDispatchListener
{
    ...
    public static function serviceLinks(GenericEvent $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('CmfcmfOAuthModule', 'user', 'main'), 'text' => __('Link Text'));
    }
}
