...
use Cmfcmf\OAuthModule\Util\ControllerUtil as ConcreteControllerUtil;
...
class ViewUtil extends Zikula_AbstractBase
{
    ...
    {
        $extParams = array();
        $hasAdminAccess = SecurityUtil::checkPermission('CmfcmfOAuthModule:' . ucwords($objectType) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
