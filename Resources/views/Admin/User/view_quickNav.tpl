{* purpose of this template: users view filter form in admin area *}
{checkpermissionblock component='CmfcmfOAuthModule:User:' instance='::' level='ACCESS_EDIT'}
{assign var='objectType' value='user'}
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="cmfcmfOAuthModuleUserQuickNavForm" class="cmfcmfoauthmodule-quicknav {*form-inline*}navbar-form" role="navigation">
    <fieldset>
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        oauthInitQuickNavigation('user', 'admin');
