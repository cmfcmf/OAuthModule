{* purpose of this template: mapped ids delete confirmation view in user area *}
...
<div class="cmfcmfoauthmodule-mappedid cmfcmfoauthmodule-delete">
    ...
    <form class="form-horizontal" action="{modurl modname='CmfcmfOAuthModule' type='user' func='delete' ot='mappedId' id=$mappedId.id}" method="post" role="form">
        <div>
            ...
            <fieldset>
                ...
                <div class="col-lg-offset-3 col-lg-9">
                    ...
                    <a href="{modurl modname='CmfcmfOAuthModule' type='user' func='view' ot='mappedId'}" class="btn btn-default" role="button"><span class="fa fa-times"></span> {gt text='Cancel'}</a>
                </div>
                </div>
            </fieldset>
