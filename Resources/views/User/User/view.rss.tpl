{* purpose of this template: users rss feed in user area *}
...
{foreach item='user' from=$items}
    <item>
        ...
        <link>{modurl modname='CmfcmfOAuthModule' type='user' func='view' ot='user' fqurl='1'}</link>
        <guid>{modurl modname='CmfcmfOAuthModule' type='user' func='view' ot='user' fqurl='1'}</guid>
