...
/**
 * The cmfcmfoauthmoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_cmfcmfoauthmoduleTemplateSelector($params, $view)
{
