...
function oauthReadDate(val, includeTime)
{
 ...
 */
function oauthAddCommonValidationRules(objectType, id)
{
    Validation.addAllThese([
        ['validate-nospace', Zikula.__('No spaces', 'module_cmfcmfoauthmodule_js'), function(val, elem) {
            var valStr;
