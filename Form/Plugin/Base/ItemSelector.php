...
class ItemSelector extends Zikula_Form_Plugin_TextInput
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            PageUtil::addVar('javascript', 'Cmfcmf/OAuthModule/Resources/public/js/CmfcmfOAuthModule_finder.js');
            PageUtil::addVar('stylesheet', ThemeUtil::getModuleStylesheet('CmfcmfOAuthModule'));
        }
        $firstTime = false;

        if (!SecurityUtil::checkPermission('CmfcmfOAuthModule:' . ucwords($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
