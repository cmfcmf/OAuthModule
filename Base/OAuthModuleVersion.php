 ...
 * @version Generated by ModuleStudio 0.6.1 (http://modulestudio.de) at Sun Nov 24 12:47:49 CET 2013.
 */
...
*/
        ...
        $meta['securityschema'] = array(
            ...
            'CmfcmfOAuthModule:User:' => 'User ID::',
        );
    ...
    protected function setupHookBundles()
    {
        ...
        $bundle = new SubscriberBundle($this->name, 'subscriber.cmfcmfoauthmodule.ui_hooks.users', 'ui_hooks', __('cmfcmfoauthmodule Users Display Hooks'));
        
        // Display hook for view/display templates.
        $bundle->addEvent('display_view', 'cmfcmfoauthmodule.ui_hooks.users.display_view');
        // Display hook for create/edit forms.
        $bundle->addEvent('form_edit', 'cmfcmfoauthmodule.ui_hooks.users.form_edit');
        // Display hook for delete dialogues.
        $bundle->addEvent('form_delete', 'cmfcmfoauthmodule.ui_hooks.users.form_delete');
        // Validate input from an ui create/edit form.
        $bundle->addEvent('validate_edit', 'cmfcmfoauthmodule.ui_hooks.users.validate_edit');
        // Validate input from an ui create/edit form (generally not used).
        $bundle->addEvent('validate_delete', 'cmfcmfoauthmodule.ui_hooks.users.validate_delete');
        // Perform the final update actions for a ui create/edit form.
        $bundle->addEvent('process_edit', 'cmfcmfoauthmodule.ui_hooks.users.process_edit');
        // Perform the final delete actions for a ui form.
        $bundle->addEvent('process_delete', 'cmfcmfoauthmodule.ui_hooks.users.process_delete');
        $this->registerHookSubscriberBundle($bundle);

        $bundle = new SubscriberBundle($this->name, 'subscriber.cmfcmfoauthmodule.filter_hooks.users', 'filter_hooks', __('cmfcmfoauthmodule Users Filter Hooks'));
        // A filter applied to the given area.
        $bundle->addEvent('filter', 'cmfcmfoauthmodule.filter_hooks.users.filter');
        $this->registerHookSubscriberBundle($bundle);
